...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_post:
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_BODY:
            ...
            print(
                FAIL_COLOR
                + "One or more of your test cases for POST() do not seem to be testing the contents of the \
                response.\n"
            )
        ...
        if (
            ...
            print(
                FAIL_COLOR
                + "You do not seem to have TWO separate test cases, one for each possible prediction that \
                your model can make."
            )

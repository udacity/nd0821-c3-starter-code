...
def map_country_to_continent(cntry, config_file) -> str:
    ...
    '''
    str_continent = 'Other'
    if cntry in list(config_file['etl']['non_converting_countries']): return cntry
    if cntry in list(config_file['etl']['north_west_south_europe']): return 'North_West_South_Europe'
    if cntry in list(config_file['etl']['south_east_europe']): return 'South_East_Europe'
    if cntry in list(config_file['etl']['caribbean']): return 'Caribbean'
    if cntry in list(config_file['etl']['central_america']): return 'Central_America'
    if cntry in list(config_file['etl']['south_america']): return 'South_America'
    if cntry in list(config_file['etl']['south_east_asia']): return 'South_East_Asia'
    if cntry in list(config_file['etl']['australia']): return 'Australia'
    if cntry in list(config_file['etl']['south_middle_asia']): return 'South_Middle_Asia'
    if cntry in list(config_file['etl']['east_asia']): return 'East_Asia'

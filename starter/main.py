...
class Item(BaseModel):
    model_name: str # This is the current model tag. Each model has a unique tag
...
def inference(item: Item):
    ...
    return {"model_name": item.model_name , "precision": precision, "recall": recall, "fbeta": fbeta}

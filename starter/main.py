...
# load model
api_model = load_model(os.path.join('starter', 'model', 'model_dtc.pkl'))
...
async def predict(input_data: ModelInput):
    ...
    encoder = load_encoder(os.path.join('starter', 'model', 'encoder_dtc.pkl'))
    lb = load_lb(os.path.join('starter', 'model', 'lb_dtc.pkl'))
